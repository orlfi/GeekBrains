...
{
    public class OrmCardsRepository : ICardRepository
    {
        private readonly BankContext _db;
        private readonly ILogger<OrmCardsRepository> _logger;

        private DbSet<Card> _set => _db.Cards;

        public OrmCardsRepository(BankContext db, ILogger<OrmCardsRepository> logger)
        {
            _db = db;
            _logger = logger;
        }
