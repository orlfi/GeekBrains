...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'e:/Projects/GeekBrains/3.AspNetCoreWebApi/Metrics/MetricsManager/ClientApp/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'e:/Projects/GeekBrains/3.AspNetCoreWebApi/Metrics/MetricsManager/ClientApp/node_modules/warning/warning.js';
...
import lang_ruRU0 from "e:/Projects/GeekBrains/3.AspNetCoreWebApi/Metrics/MetricsManager/ClientApp/src/locales/ru-RU.ts";
...
export const getIntl = (locale?: string, changeIntl?: boolean) => {
  ...
  // 使用 zh-CN
  if (localeInfo["ru-RU"]) return createIntl(localeInfo["ru-RU"]);
